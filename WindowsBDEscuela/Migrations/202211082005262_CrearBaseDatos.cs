    ...
    public partial class CrearBaseDatos : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Carreras", t => t.CarreraId, cascadeDelete: false)
                .Index(t => t.CarreraId);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Profesors", t => t.ProfesorId, cascadeDelete: false)
                .ForeignKey("dbo.Materias", t => t.MateriaId, cascadeDelete: false)
                .Index(t => t.CarreraId)
                .Index(t => t.MateriaId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Planillas", t => t.PlanillaId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Detalles", t => t.DetalleId, cascadeDelete: false)
                .ForeignKey("dbo.Estudiantes", t => t.EstudianteId, cascadeDelete: false)
                .ForeignKey("dbo.Tipoes", t => t.TipoId, cascadeDelete: false)
                .Index(t => t.TipoId)
